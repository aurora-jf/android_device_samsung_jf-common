...
camera_module_t HAL_MODULE_INFO_SYM = {
    .common = {
         ...
         .dso = NULL, /* Remove Compilation Warning */
         .reserved = {0}, /* Remove Compilation Warning */
    },
    .get_number_of_cameras = camera_get_number_of_cameras,
    .get_camera_info = camera_get_camera_info,
    .set_callbacks = NULL, /* Remove Compilation Warning */
    .get_vendor_tag_ops = NULL, /* Remove Compilation Warning */
    .open_legacy = NULL, /* Remove Compilation Warning */
    .set_torch_mode = NULL, /* Remove Compilation Warning */
    .init = NULL, /* Remove Compilation Warning */
    .reserved = {0}, /* Remove Compilation Warning */
};
...
static char *camera_fixup_setparams(struct camera_device *device, const char *settings)
{
    ...
    /* Disable ZSL During Video Capture */
    if (isVideo) {
